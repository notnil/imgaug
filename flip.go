...
func (f FlipLR) Transform(cfg *Config, img image.Image, labels Labels) (image.Image, Labels) {
...
func (f FlipUD) Transform(cfg *Config, img image.Image, labels Labels) (image.Image, Labels) {
